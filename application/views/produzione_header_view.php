            ...
            <div id="segnaposto">
    <?php
        echo anchor('welcome','<div id="sp1" class="segnaposto_class "><div class="testo"><p>'.$menu1.'</p></div></div>');
    ?>
    ...
    ?>
        <?php
        echo anchor('produzione','<div id="sp3" class="segnaposto_class segnaposto_class_selected "><div class="testo"><p>'.$menu3.'</p></div></div>');
    ?>
        <?php
